  ...
  return (
    ...
    <div className='relative font-["Open_sans"] font-black text-white text-center md:text-start'>
      <div className='opacity-80 animate__animated animate__slideInDown'>
         ...
         <div className='absolute flex md:justify-end lg:justify-center md:pr-[15%] lg:pr-0 top-0 md:top-[20%] lg:top-[-15%] w-full animate__animated animate__slideInUp animate__delay-1s'>
          <img className='mx-auto md:mx-0 lg:mx-auto w-44 md:w-60 lg:w-44' src={HeroImg} />
        <div className='marker inline absolute leading-[60px] rotate-[353deg] lg:top-56  md:right-0  lg:left-0 md:top-72 top-64 left-[13%] right-[13%] text-[55px] md:text-[75px]'>
